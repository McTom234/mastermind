...
export const getServerSideProps: GetServerSideProps<never, {room: string, name: string}> = async ({params}) => {
  if (!params)
    throw new Error('Join parameters are not set. Go to /join, to start again. If you have no success, submit a bug report at https://github.com/McTom234/mastermind/issues/new.')
