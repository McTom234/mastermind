    ...
    <div className={styles.container}>
      ...
      <div className={`${slotStyles.container} ${styles.feedbackContainer} ${pinStyles.feedbackPin}`}>
        <Pin
          ...
          onClick={() => props.setFeedbackPinCallback(1)}
          initialColor={props.slot.feedback.pin1.color}
          colorStyle={pinStyles.feedbackColor}
        />
        <Pin
          selectable={selectable}
          onClick={() => props.setFeedbackPinCallback(2)}
          initialColor={props.slot.feedback.pin2.color}
          colorStyle={pinStyles.feedbackColor}
        />
        <Pin
          selectable={selectable}
          onClick={() => props.setFeedbackPinCallback(3)}
          initialColor={props.slot.feedback.pin3.color}
          colorStyle={pinStyles.feedbackColor}
        />
        <Pin
          selectable={selectable}
          onClick={() => props.setFeedbackPinCallback(4)}
